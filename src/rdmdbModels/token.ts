...
export class token extends Model<tokenAttributes, tokenCreationAttributes> implements tokenAttributes {
	...
	public setuser!: Sequelize.BelongsToSetAssociationMixin<user, userId>;
	public createuser!: Sequelize.BelongsToCreateAssociationMixin<user>;

	public static initModel(sequelize: Sequelize.Sequelize): typeof token {
		token.init(
			{
				token: {
