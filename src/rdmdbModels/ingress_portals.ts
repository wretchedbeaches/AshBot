...
export class ingress_portals extends Model<ingress_portalsAttributes, ingress_portalsCreationAttributes> implements ingress_portalsAttributes {
  id!: number;
  external_id?: string;
  lat?: number;
  lon?: number;
  ...
  static initModel(sequelize: Sequelize.Sequelize): typeof ingress_portals {
