...
export class web_session extends Model<web_sessionAttributes, web_sessionCreationAttributes> implements web_sessionAttributes {
  token!: string;
  userid?: string;
  created!: number;
  updated!: number;
  ...
  static initModel(sequelize: Sequelize.Sequelize): typeof web_session {
    web_session.init({
    token: {
