...
export class pokemon extends Model<pokemonAttributes, pokemonCreationAttributes> implements pokemonAttributes {
	...
	public cp?: number;
	public atk_iv?: number;
	public def_iv?: number;
	public sta_iv?: number;
	public form?: number;
	public level?: number;
	...
	public expire_timestamp_verified!: number;
	public display_pokemon_id?: number;
	public shiny?: number;
	public username?: string;
	public capture_1?: number;
	public capture_2?: number;
	public capture_3?: number;
	public pvp_rankings_great_league?: string;
	public pvp_rankings_ultra_league?: string;
	public is_event!: number;
	...
	public getpokestop!: Sequelize.BelongsToGetAssociationMixin<pokestop>;
	public setpokestop!: Sequelize.BelongsToSetAssociationMixin<pokestop, pokestopId>;
	public createpokestop!: Sequelize.BelongsToCreateAssociationMixin<pokestop>;
	// pokemon belongsTo spawnpoint
	public spawnpoint!: spawnpoint;
	public getspawnpoint!: Sequelize.BelongsToGetAssociationMixin<spawnpoint>;
	public setspawnpoint!: Sequelize.BelongsToSetAssociationMixin<spawnpoint, spawnpointId>;
	public createspawnpoint!: Sequelize.BelongsToCreateAssociationMixin<spawnpoint>;

	public static initModel(sequelize: Sequelize.Sequelize): typeof pokemon {
		pokemon.init(
			{
				id: {
