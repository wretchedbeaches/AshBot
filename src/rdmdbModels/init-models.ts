...
export function initModels(sequelize: Sequelize) {
  ...
  device.belongsToMany(device_group, { through: device_group_device as typeof Model, foreignKey: "device_uuid", otherKey: "device_group_name" });
  device_group.belongsToMany(device, { through: device_group_device as typeof Model, foreignKey: "device_group_name", otherKey: "device_uuid" });
