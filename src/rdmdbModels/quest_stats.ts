...
export class quest_stats
	extends Model<quest_statsAttributes, quest_statsCreationAttributes>
	implements quest_statsAttributes
{
	public date!: string;
	...
	public static initModel(sequelize: Sequelize.Sequelize): typeof quest_stats {
		quest_stats.init(
			{
				date: {
				...
				indexes: [
					{
						...
						unique: true,
						using: 'BTREE',
						fields: [{ name: 'date' }, { name: 'reward_type' }, { name: 'pokemon_id' }, { name: 'item_id' }],
					},
				],
			},
		);
