...
export class pokemon_iv_stats extends Model<pokemon_iv_statsAttributes, pokemon_iv_statsCreationAttributes> implements pokemon_iv_statsAttributes {
  date!: string;
  pokemon_id!: number;
  count!: number;


  static initModel(sequelize: Sequelize.Sequelize): typeof pokemon_iv_stats {
