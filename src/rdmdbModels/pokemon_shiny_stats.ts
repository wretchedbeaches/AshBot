...
export class pokemon_shiny_stats
	extends Model<pokemon_shiny_statsAttributes, pokemon_shiny_statsCreationAttributes>
	implements pokemon_shiny_statsAttributes
{
	public date!: string;
	public pokemon_id!: number;
	public count!: number;

	public static initModel(sequelize: Sequelize.Sequelize): typeof pokemon_shiny_stats {
