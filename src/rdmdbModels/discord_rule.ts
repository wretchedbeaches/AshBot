...
export class discord_rule extends Model<discord_ruleAttributes, discord_ruleCreationAttributes> implements discord_ruleAttributes {
  priority!: number;
  server_id!: number;
  role_id?: number;
  group_name!: string;
  ...
  static initModel(sequelize: Sequelize.Sequelize): typeof discord_rule {
    discord_rule.init({
    priority: {
