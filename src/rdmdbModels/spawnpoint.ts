...
export class spawnpoint
	extends Model<spawnpointAttributes, spawnpointCreationAttributes>
	implements spawnpointAttributes
{
	public id!: number;
	public lat!: number;
	public lon!: number;
	public updated!: number;
	public despawn_sec?: number;
	...
	public static initModel(sequelize: Sequelize.Sequelize): typeof spawnpoint {
		spawnpoint.init(
			{
				id: {
