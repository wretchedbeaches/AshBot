...
export class gym extends Model<gymAttributes, gymCreationAttributes> implements gymAttributes {
	...
	public raid_end_timestamp?: number;
	public raid_spawn_timestamp?: number;
	public raid_battle_timestamp?: number;
	public updated!: number;
	public raid_pokemon_id?: number;
	public guarding_pokemon_id?: number;
	public availble_slots?: number;
	public team_id?: number;
	public raid_level?: number;
	public enabled?: number;
	public ex_raid_eligible?: number;
	public in_battle?: number;
	public raid_pokemon_move_1?: number;
	public raid_pokemon_move_2?: number;
	public raid_pokemon_form?: number;
	public raid_pokemon_cp?: number;
	public raid_is_exclusive?: number;
	public cell_id?: number;
	public deleted!: number;
	public total_cp?: number;
	public first_seen_timestamp!: number;
	public raid_pokemon_gender?: number;
	public sponsor_id?: number;
	public raid_pokemon_costume?: number;
	public raid_pokemon_evolution?: number;
	...
	public static initModel(sequelize: Sequelize.Sequelize): typeof gym {
		gym.init(
			{
				id: {
			...
			},
			{
				...
				indexes: [
					...
					},
					{
						...
						using: 'BTREE',
						fields: [{ name: 'raid_end_timestamp' }],
					},
					{
						name: 'ix_updated',
						using: 'BTREE',
