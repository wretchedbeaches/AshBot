...
export class device_group_device extends Model<device_group_deviceAttributes, device_group_deviceCreationAttributes> implements device_group_deviceAttributes {
  device_group_name!: string;
  device_uuid!: string;
  ...
  setdevice_group!: Sequelize.BelongsToSetAssociationMixin<device_group, device_groupId>;
  ...
  static initModel(sequelize: Sequelize.Sequelize): typeof device_group_device {
